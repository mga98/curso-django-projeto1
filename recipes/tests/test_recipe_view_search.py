...
class RecipeSearchViewTest(RecipeTestBase):
    def test_recipe_search_view_function_is_correct(self):
        ...
        self.assertIs(view.func.view_class, views.RecipeSearch)
    ...
    def test_recipe_search_term_is_on_page_title_and_scaped(self):
        ...
        self.assertIn('Pesquisa por &quot;&lt;test_term&gt;&quot;', content)
    ...
    def test_recipe_search_can_find_recipe_by_title(self):
        ...
        recipe1 = self.make_recipe(
            title=title1, slug='test-search-one', author_data={'username': 'one'}
            )

        recipe2 = self.make_recipe(
            title=title2, slug='test-search-two', author_data={'username': 'two'}
            )
